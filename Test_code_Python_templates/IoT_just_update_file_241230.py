...
# file name: IoT_just_update_file_241230.py - updates the details of an existing file in a File gallery
...
#    sudo python3 /your_file_path/IoT_just_update_file_241230.py
