...
# file name: IoT_just_download_web_page_241230.py - downloads the content of a web page and its associated wiki parameters
...
#    sudo python3 /your_file_path/IoT_just_download_web_page_241230.py
