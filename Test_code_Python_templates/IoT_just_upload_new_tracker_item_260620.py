...
# file name: IoT_just_upload_new_tracker_item_260620.py - uploads a new item to a tracker
...
#    sudo python3 /your_file_path/IoT_just_upload_new_tracker_item_260620.py
...
post_itemdata =  "fields[IoTtestDeviceName]=rpi5-01&fields[IoTtestUser]=rpi5-01&fields[IoTtestTextData]=just some text&fields[IoTtestNumericalData]=123.456&fields[IoTtestDateTimeData]=" + str(nowepoch) + "&fields[IoTtestTextAreaData]= 'C' code version 260620 for no apostrophies around itemId\r\ntext data line 1\r\ntext data line 2\r\n&fields[IoTtestImage]=1&fields[IoTtestDescription]=data input from the rpi05-01 device using C code version 260620 called from a python program v 260620"
