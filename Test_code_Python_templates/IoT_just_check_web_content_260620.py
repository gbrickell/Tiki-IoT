...
# file name: IoT_just_check_web_content_260620.py - looks for some specific content on a defined web page
...
#    sudo python3 /your_file_path/IoT_just_check_web_content_260620.py
