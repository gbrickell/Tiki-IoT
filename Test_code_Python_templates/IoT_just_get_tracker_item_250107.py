...
# file name: IoT_just_get_tracker_item_250107.py - downloads the field data of a specified tracker item
...
#    sudo python3 /your_file_path/IoT_just_get_tracker_item_250107.py
