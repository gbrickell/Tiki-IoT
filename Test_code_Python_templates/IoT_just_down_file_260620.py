...
# file name: IoT_just_down_file_260620.py - just downloads a file from a File gallery defined by its Tiki fileId#
...
#    sudo python3 /your_file_path/IoT_just_down_file_260620.py
